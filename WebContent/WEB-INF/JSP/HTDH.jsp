...
<body>
		...
		<div class="navbar navbar-inverse">
           <ul class="nav navbar-nav">
			  <li><img src="${pageContext.request.contextPath}/img/daohang/1.jpg"></li>4
			  <li><a href="#" style="font-size: large;">预约管理</a></li>            
			  <li><a href="#" style="font-size: large;">个人信息</a></li>
              <li><a href="#" style="font-size: large;">代卖车辆</a></li>
    		  <li><a href="#" style="font-size: large;">砍价管理</a></li>
